<%-- 
    ...
    Created on : 9 Jan, 2024, 1:39:16 PM
    Author     : akash
--%>
...
//                                 String str="select count(*) from cancel_order_laptop";
...
<!--                                 <tr>
                                     <td width="250px"align="center"style="font-size: x-large">Cancel No</td>
                                     <td width="250px"align="center"><></td>
                                 </tr>
                                 <tr>
                                     <td width="250px"align="center"style="font-size: x-large">Cancel Date</td>
                                     <td width="250px"align="center"><input type="date" name="txtcand" value="" /></td>
                                 </tr>-->
                              ...
                              String str1="select * from confirm_laptop_order where Order_No="+cid1+"";
                                    ...
                                    while(rs1.next())
                                {
                                 ...
                                 <tr>
                                     ...
                                     <td colspan="2" width="250px"align="center"style="font-size: x-large"><a href="Confirm Cancel Laptop Order.jsp">Cancel Order</a></td>
