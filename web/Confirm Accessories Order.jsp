<%-- 
    Document   : Confirm Accessories Order
    Created on : 10 Feb, 2024, 12:41:31 PM
    Author     : akash
--%>
      ...
      <div class="about">
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-5">
                  <div class="titlepage">
                   <h3 style="background: powderblue;font-size: xx-large;font-family: serif"align="center">Confirm Accessories Order</h3>
                    <form>
                       <table cellpadding="9"style="font-family: initial"width="450px"height="450px">
                             <tbody>
                                 <tr>
                                     ...
                                     <td width="250px"align="left"><%=i3%></td>
                                 </tr>
                                 <tr>
                                     <tr>
                             ...
                             <td class="selected"align="left"style="font-size: x-large"><%=cnm%></td>
                                 ...
                                 <tr>
                                     ...
                                     <td width="250px"align="left"><%=anm2%></td>
                                 </tr>
                                 <tr>
                                 ...
                                 <tr>
                                     <td width="250px"align="left"style="font-size: x-large">Quantity</td>
                                     <td width="250px"align="left"><input type="text" name="txtque" value="" /></td>
                                 </tr>
                                 ...
                                 String ass="Accessories";
                                  ...
                                  if(ordd!=null && ordd!="" && que!=null && que!="" && pinc!=null && pinc!="")
                                  {
                                      String str3="insert into confirm_accessories_order(Order_No,Order_Date,Company_Name,Material_Id,Material_Name,Warranty,Image,Price,Quantity,Name,Address,Mobile_No,Pin_Code,aname,uname)values("+i3+",'"+ordd+"','"+cnm+"',"+id5+",'"+anm2+"','"+war2+"','"+img2+"',"+price3+","+que+",'"+cusn2+"','"+add2+"',"+mobn3+",'"+pinc+"','"+ass+"','"+nm+"')";
