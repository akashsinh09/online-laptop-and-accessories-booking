<%-- 
    Document   : About  Us
    Created on : 24 Jan, 2024, 8:53:35 PM
    Author     : akash
--%>
         ...
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-5">
                  <div class="titlepage">
                     <h2>About Us</h2>
                     <p>We are the Online Seller Of Laptops And Accessories,Thank you for choosing Laptop and accessories Store India as your trusted laptop provider! 🌟</p>
                  </div>
               </div>
               <div class="col-md-7">
                  <div class="about_img">
