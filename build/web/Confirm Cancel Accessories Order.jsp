<%-- 
    Document   : Confirm Cancel Accessories Order
    Created on : 5 Mar, 2024, 3:32:51 PM
    Author     : akash
--%>
                    ...
                    <form method="post" name="form">
                          <table cellpadding="9"style="font-family: initial"width="450px"height="450px">
                             <tbody>
                                 ...
                                 String str="select count(*) from confirm_cancel_accessories_order";
...
//                                 out.println("cid="+cid);
                                 ...
                                 <%
                                     ...
                                     if(cand!=null && cand!="")
                                     {
                                         String str3="insert into confirm_cancel_accessories_order(id,cancel_date,order_no,material_name,customer_name,address,mobile_no,order_date)values("+i+",'"+cand+"',"+cid3+",'"+nm3+"','"+cusn4+"','"+add4+"',"+mobn5+",'"+odt3+"')";
                                      int a=st2.executeUpdate(str3);
